...
export var ExampleComponent = (function () {
    function ExampleComponent(pdfmake) {
    ...
    ExampleComponent.prototype.ngOnInit = function () {
        ...
        var header1 = new Cell('Header1');
        var header2 = new Cell('Header2');
        var header3 = new Cell('Header3');
        var headerRows = new Row([header1, header2, header3]);
        var row1 = new Row([new Cell('One value goes here '), new Cell('Another one here'), new Cell('OK?')]);
        var widths = [100, '*', 200, '*'];
        var table = new Table(headerRows, [row1], widths);
        this.pdfmake.addTable(table);
        var list1 = ['item 1', 'item 2', 'item 3'];
        var list2 = ['item 1', 'item 2', 'item 3'];
        var list3 = ['item 1', 'item 2', 'item 3'];
        var list4 = ['item 1', 'item 2', 'item 3'];
